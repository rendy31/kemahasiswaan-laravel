                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Edit Kegiatan Mahasiswa</h5>
                                        {{-- <span>lorem ipsum dolor sit amet, consectetur adipisicing elit</span> --}}
                                    </div>
                                    <div class="card-block">
                                        <form action="{{ route('kegiatan-mahasiswa.update',['studentActivity'=>$studentActivity->id]) }}" method="post"
                                            ...
                                            <div class="form-group @error('title') has-danger @enderror row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text"
                                                        ...
                                                        id="colFormLabelSm" name="title" value="{{ old('title') ?? $studentActivity->title }}">
                                                    @error('title')
                                            ...
                                            <div class="form-group @error('thumbnail') has-danger @enderror row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    @enderror
                                                    <img src="{{ Storage::url($studentActivity->thumbnail) }}" class="img-fluid img-thumbnail w-25 mt-1" >
                                                </div>
                                            </div>
                                            <div class="form-group @error('content') has-danger @enderror row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea id="summernote" class="form-control @error('content') form-control-danger @enderror" name="content">{{ old('content') ?? $studentActivity->content }}</textarea>
                                                    @error('content')
                                                        <span class="col-form-label">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                    ...
                                                    <div class="col-sm-10 form-check form-switch mt-2">
                                                        <input name="isPublish" class="form-check-input" type="checkbox"
                                                            role="switch" id="flexSwitchCheckChecked" {{$studentActivity->isPublish == 1 ? 'checked':''}}>
