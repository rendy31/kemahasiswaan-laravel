...
@section('content')
    ...
    <section id="starter-section" class="starter-section section">
        ...
        <div class="container section-title" data-aos="fade-up">
            ...
            <p><span>Daftar Prestasi Mahasiswa - Provinsi</span> </p>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('prestasiProvinsi') }}">Provinsi</a>
                </li>
                <li class="nav-item">
                                ...
                                @foreach ($data as $prodi => $rekap)
                                    <tr>
                                        ...
                                        @foreach ($peringkat as $j)
                                            <td>
                                                <a
                                                    href="{{ route('prestasi.mahasiswa', ['prodi' => $prodi, 'peringkat' => $j, 'level' => 'Provinsi']) }}">
                                                    {{ $rekap[$j] }}
                                                </a>
                                            </td>
                                        @endforeach
