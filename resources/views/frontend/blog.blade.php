...
@section('content')
    <!-- Page Title -->
    <div class="page-title dark-background" style="background-image: url(assets/frontend/img/ruangkuliah1.jpg);">
                ...
                <div class="col-lg-4">
                    <article>
                        ...
                        <div class="post-img">
                            ...
                            {{-- <img src="{{url('assets/frontend/img/blog/blog-1.jpg')}}" alt="" class="img-fluid"> --}}
                        </div>
