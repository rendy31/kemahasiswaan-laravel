...
@section('content')
    <!-- Page Title -->
    <div class="page-title dark-background" style="background-image: url(assets/frontend/img/ruangkuliah2.jpg);">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4">
                    <article>
                        ...
                        <h2 class="title">
                            <a href="{{ route('scholarship.detail', $item->slug) }}">{{$item->title}}</a>
                        </h2>
